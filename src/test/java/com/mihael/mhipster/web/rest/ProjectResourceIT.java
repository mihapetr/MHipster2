...
import static com.mihael.mhipster.domain.ProjectAsserts.*;
...
class ProjectResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_CREATION_TIME_STAMP = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_CREATION_TIME_STAMP = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project()
            ...
            .creationTimeStamp(DEFAULT_CREATION_TIME_STAMP)
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project updatedProject = new Project()
            ...
            .creationTimeStamp(UPDATED_CREATION_TIME_STAMP)
    ...
    void getAllProjects() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.[*].creationTimeStamp").value(hasItem(sameInstant(DEFAULT_CREATION_TIME_STAMP))))
    ...
    void getProject() throws Exception {
        ...
        restProjectMockMvc
            ...
            .andExpect(jsonPath("$.creationTimeStamp").value(sameInstant(DEFAULT_CREATION_TIME_STAMP)))
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).creationTimeStamp(UPDATED_CREATION_TIME_STAMP);
