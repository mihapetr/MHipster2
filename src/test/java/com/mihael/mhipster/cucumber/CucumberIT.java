...
//@SelectClasspathResource("features/account.feature") // Path to feature files
@SelectClasspathResource("features/generating_projects.feature") // Path to feature files
