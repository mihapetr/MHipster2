...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'b1c38149-7828-429d-98be-dd19ec34533c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('1491b10e-ad01-4272-9b22-a6c40ddab443');
      cy.get(`[data-cy="name"]`).should('have.value', '1491b10e-ad01-4272-9b22-a6c40ddab443');
